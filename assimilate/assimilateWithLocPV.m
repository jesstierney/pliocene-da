function[] = assimilateWithLocPV(label, timeSlice, estimatesLabel, Rlabel, radius, runs, sites)
...
[Y, Ye, R, members, YeFile] = loadCoreInputsPV(estimatesLabel, Rlabel, runs, sites);
