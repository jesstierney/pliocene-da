function[] = IPSL_CM5A_e280
%% IPSL_CM5A_e280  Pre-processes the data for the IPSL-CM5A E280 run
% ----------
%   IPSL_CM5A_e280
...
% ----------
%   Outputs:
%       Creates a NetCDF file named "IPSL-CM5A_e280.nc" in the current
%       directory.

% Get the files
prFile =      "PI.TotalPrecip_pr_3600_3699_monthly_TS.nc";
tasFile =     "PI.NearSurfaceTemp_tas_3600_3699_monthly_TS.nc";
tosFile =     "PI.SeasurfaceTemp_sst_3600_3699_monthly_TS.nc";
sosFile =     "piControl_IPSLCM5A_SSS.nc";
siconcFile =  "PI.Sicfraction_sic_3600_3699_monthly_TS.nc";

% Load variables
pr = ncread(prFile, 'pr');
tas = ncread(tasFile, 'tas');
tos = ncread(tosFile, 'sst');
sos = ncread(sosFile, 'sosaline');
