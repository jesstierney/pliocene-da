function[] = EC_Earth3_3_eoi400
%% EC_Earth3_3_eoi400  Pre-processes the data for the EC_Earth3_3 eoi400 run
% ----------
%   EC_Earth3_3_eoi400
...
% ----------
%   Outputs:
%       Creates a NetCDF file named "EC-Earth3.3_eoi400.nc" in the current
%       directory.

% Get the file patterns
prPattern =   "pr_Amon_EC-Earth3-LR_midPliocene-eoi400_r1i1p1f1_gr_%4.f01-%4.f12.nc";
tasPattern =  "tas_Amon_EC-Earth3-LR_midPliocene-eoi400_r1i1p1f1_gr_%4.f01-%4.f12.nc";
tosPattern =     "tos_Omon_EC-Earth3-LR_midPliocene-eoi400_r1i1p1f1_gn_%4.f01-%4.f12.nc";
sosPattern =     "sos_Omon_EC-Earth3-LR_midPliocene-eoi400_r1i1p1f1_gn_%4.f01-%4.f12.nc";
siconcPattern =  "siconc_SImon_EC-Earth3-LR_midPliocene-eoi400_r1i1p1f1_gn_%4.f01-%4.f12.nc";
