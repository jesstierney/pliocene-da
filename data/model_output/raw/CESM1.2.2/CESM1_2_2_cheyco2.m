function[] = CESM1_2_2_cheyco2
%% CESM1_2_2_cheyco2  Pre-processes the data for the CESM1.2.2 cheyco2 run
% ----------
%   CESM1_2_2_cheyco2
...
% ----------
%   Outputs:
%       Creates a NetCDF file named "CESM1.2.2_cheyco2.nc" in the current
%       directory.

% Set exported NetCDF file
exportFile = "CESM1.2.2_cheyco2.nc";
...
files = [...
    "chey_co2_2_rhminl_PreInd_T31_gx3v7.cam.h0.%02.f.mavg_1701-1800.nc";
    "chey_co2_2_rhminl_PreInd_T31_gx3v7.cam.h0.%02.f.mavg_1701-1800.nc";
    "chey_co2_2_rhminl_PreInd_T31_gx3v7.cam.h0.%02.f.mavg_1701-1800.nc";
    "chey_co2_2_rhminl_PreInd_T31_gx3v7.pop.h.%02.f.mavg_1701-1800.nc";
    "chey_co2_2_rhminl_PreInd_T31_gx3v7.pop.h.%02.f.mavg_1701-1800.nc";
    "chey_co2_2_rhminl_PreInd_T31_gx3v7.cam.h0.%02.f.mavg_1701-1800.nc";
    ];
