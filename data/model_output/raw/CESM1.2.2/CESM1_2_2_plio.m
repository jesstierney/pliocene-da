function[] = CESM1_2_2_plio
%% CESM1_2_2_plio  Pre-processes the data for the CESM1.2.2 plio run
% ----------
%   CESM1_2_2_plio
...
% ----------
%   Outputs:
%       Creates a NetCDF file named "CESM1.2.2_plio.nc" in the current
%       directory.

% Set exported NetCDF file
exportFile = "CESM1.2.2_plio.nc";
...
files = [...
    "Plio_ciso_T31_gx3v7.cam.h0.2901-3000._%02.f_climo.nc";
    "Plio_ciso_T31_gx3v7.cam.h0.2901-3000._%02.f_climo.nc";
    "Plio_ciso_T31_gx3v7.cam.h0.2901-3000._%02.f_climo.nc";
    "Plio_ciso_T31_gx3v7.pop.h.2901-3000._%02.f_climo.nc";
    "Plio_ciso_T31_gx3v7.pop.h.2901-3000._%02.f_climo.nc";
    "Plio_ciso_T31_gx3v7.cam.h0.2901-3000._%02.f_climo.nc";
    ];
