function[] = GISS_ModelE2_eoi400
%% GISS_ModelE2_eoi400  Pre-processes the data for the GISS-ModelE2 eoi400 run
% ----------
%   GISS_ModelE2_eoi400
...
% ----------
%   Outputs:
%       Creates a NetCDF file named "GISS-ModelE2_eoi400.nc" in the current
%       directory.

% Get the file patterns
prPattern =   "pr_Amon_GISS-E2-1-G_midPliocene-eoi400_r1i1p1f1_gn_%4.f01-%4.f12.nc";
tasPattern =  "tas_Amon_GISS-E2-1-G_midPliocene-eoi400_r1i1p1f1_gn_%4.f01-%4.f12.nc";
tosPattern =     "tos_Omon_GISS-E2-1-G_midPliocene-eoi400_r1i1p1f1_gn_%4.f01-%4.f12.nc";
sosPattern =     "sos_Omon_GISS-E2-1-G_midPliocene-eoi400_r1i1p1f1_gn_%4.f01-%4.f12.nc";
siconcPattern =  "siconca_SImon_GISS-E2-1-G_midPliocene-eoi400_r1i1p1f1_gn_%4.f01-%4.f12.nc";
...
tos = NaN(144, 90, 1200);
sos = NaN(144, 90, 1200);
siconc = NaN(144, 90, 1200);

% Iterate through file sets
startYears = [3051, 3101];
stopYears = [3100, 3150];
times = {1:600, 601:1200};
for k = 1:2
