...
exportFile = "IPSL-CM5A2_eoi400.nc";

% Note characteristics of raw output
names = ["pr","t2m","sst","sos","sic"];
...
files = [...
    "Eoi400.TotalPrecip_pr_3381_3480_monthly_TS.nc";
    "Eoi400.NearSurfaceTemp_tas_3381_3480_monthly_TS.nc";
    "Eoi400.SeasurfaceTemp_sst_3381_3480_monthly_TS.nc";
    "Eoi400_IPSLCM5A2_SSS.nc";
    "Eoi400.Sicfraction_sic_sst_3381_3480_monthly_TS.nc";
    ];
