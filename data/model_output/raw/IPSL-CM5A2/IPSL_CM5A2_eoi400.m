function[] = IPSL_CM5A2_eoi400
%% IPSL_CM5A2_eoi400  Pre-processes the data for the IPSL-CM5A2 eoi400 run
% ----------
%   IPSL_CM5A2_eoi400
...
% ----------
%   Outputs:
%       Creates a NetCDF file named "IPSL-CM5A2_eoi400.nc" in the current
%       directory.

% Get the files
prFile =      "Eoi400.TotalPrecip_pr_3381_3480_monthly_TS.nc";
tasFile =     "Eoi400.NearSurfaceTemp_tas_3381_3480_monthly_TS.nc";
tosFile =     "Eoi400.SeasurfaceTemp_sst_3381_3480_monthly_TS.nc";
sosFile =     "Eoi400_IPSLCM5A2_SSS.nc";
siconcFile =  "Eoi400.Sicfraction_sic_sst_3381_3480_monthly_TS.nc";

% Load variables
pr = ncread(prFile, 'pr');
tas = ncread(tasFile, 't2m');
