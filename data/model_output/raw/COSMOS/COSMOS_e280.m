function[] = COSMOS_e280
%% COSMOS_e280  Pre-processes the data for the COSMOS E280 run
% ----------
%   COSMOS_e280
...
% ----------
%   Outputs:
%       Creates a NetCDF file named "COSMOS_e280.nc" in the current
%       directory.

% Set exported NetCDF file
exportFile = "COSMOS_e280.nc";
...
files = [...
    "E280.TotalPrecip_CMIP6_name_pr_2650-2749_monthly_mean_time_series.nc";
    "E280.NearSurfaceAirTemp_CMIP6_name_tas_2650-2749_monthly_mean_time_series.nc";
    "E280.SeaSurfaceTemp_CMIP6_name_tos_2650-2749_monthly_mean_time_series.nc";
    "E280.SeaSurfaceSalinity_CMIP6_name_sos_2650-2749_monthly_mean_time_series.nc";
    "E280.SeaIceAreaFraction_CMIP6_name_sic_2650-2749_monthly_mean_time_series.nc";
    ];
