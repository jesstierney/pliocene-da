...
%% parameters.preindustrialRuns.pliomip2  Returns the metadata for all PlioMIP2 pre-industrial runs
% ----------
%   [runs] = parameters.preindustrialRuns.pliomip2
%   Returns the metadata for all pre-industrial climate model runs from 
%   PlioMIP2. These runs are the E280 experiments from PlioMIP2. The output
