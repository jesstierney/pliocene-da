function[runs] = all
%% parameters.plioceneRuns.all  Returns the metadata for all Pliocene-like runs
% ----------
%   [runs] = parameters.plioceneRuns.all
%   Returns the metadata for all Pliocene-like climate model runs.
%   The output has one row per run and 2 columns. The first
...
runs = [
    parameters.plioceneRuns.pliomip2;
    "CESM2",     "eo400new"
    "CESM2",     "pi400"
