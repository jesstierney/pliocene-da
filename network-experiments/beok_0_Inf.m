function[] = beok_0_Inf
%% beok  Runs proxy network experiments using all available runs, excluding COSMOS and cloud runs with dGMST outside of [0 8]
% ----------
%   beok_0_Inf
...
%           scheme beok-0-Inf_<proxy network>_<uk seasonality>.nc
%       Reconstructions: Creates 4 NetCDF files with the naming scheme
%           beok-0-Inf_<proxy network>_<uk seasonality>.nc    
