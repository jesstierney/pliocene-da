...
testParameters("preindustrial_cloud",  scaling, radii, "preindustrial_uk-med-seasonal_mgcaH",  'conservative', piRuns);
testParameters('mid-pliocene_cloud',   scaling, radii, "mid-pliocene_uk-all-annual_mgcaH",   'conservative', plioRuns);
testParameters('early-pliocene_cloud', scaling, radii, "early-pliocene_uk-all-annual_mgcaH", 'conservative', plioRuns);
